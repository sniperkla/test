...
function handleEvent(event) {
 ...
 if (event.type === 'follow') {
   ...
   client.replyMessage(event.replyToken, bigsurprise);
...
{
  "type": "flex",
  "altText": "🔥 เตรียมพบกับบิ๊กเซอร์ไพรส์ 11.11 🔥",
  "contents": {
  "type": "bubble",
  "direction": "ltr",
  "header": {
  ...
  "hero": {
    "type": "image",
    "url": "https://niki999.com/slotcat777/11.jpg",
    "gravity": "bottom",
    "size": "full",
    "aspectRatio": "1:1",
    "aspectMode": "fit"
  ...
  "body": {
    ...
    "contents": [
      ...
      {
        "type": "text",
        "text": "🎉 รับไปเลยเน้น ๆ 50% ทุกยอดฝาก",
        "weight": "regular",
        "margin": "xl",
        "contents": []
      },
      {
        "type": "text",
        "text": "🎉 ฝากขั้นต่ำ 100 สูงสุด 1000",
        "margin": "md",
        "contents": []
      },
      {
        "type": "text",
        "text": "🎉 ทำเทิร์นเพียง 3 เท่า",
        "margin": "md",
        "contents": []
      },
      {
        "type": "text",
        "text": " ⚠️ สงวนสิทธิ์รับโบนัสรวมตลอดทั้งกิจกรรมได้สูงสุด 500",
        "weight": "bold",
        "size": "md",
        "align": "start",
        "gravity": "top",
      ...
      {
        "type": "text",
        "text": "🚫 สิ้นสุด 23:59 วันที่ 11.11 🚫",
        "align": "center",
        "margin": "md",
        "contents": []
      }
